...
def setup_data() -> connect_to_arxiv.ArXivHarvester:
    harvester = connect_to_arxiv.ArXivHarvester()
    return harvester


def test_header_not_empty(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    header = harvester.get_record_header()
    assert bool(header) is True


def test_header_contain_identifier(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    header = harvester.get_record_header()
    assert isinstance(header["identifier"], str)


def test_header_contain_datestamp(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    header = harvester.get_record_header()
    assert isinstance(header["datestamp"], str)


def test_header_contain_setspec(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    header = harvester.get_record_header()
    assert isinstance(header["setSpec"], str)


def test_metadata_not_empty(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    metadata = harvester.get_record_metadata()
    assert bool(metadata) is True


def test_metadata_contain_title(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    metadata = harvester.get_record_metadata()
...
def test_metadata_contain_creator(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    metadata = harvester.get_record_metadata()
...
def test_metadata_contain_subject(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    metadata = harvester.get_record_metadata()
...
def test_metadata_contain_description(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    metadata = harvester.get_record_metadata()
...
def test_metadata_contain_date(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    metadata = harvester.get_record_metadata()
...
def test_metadata_contain_identifier(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    metadata = harvester.get_record_metadata()
...
def test_metadata_contain_type(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    metadata = harvester.get_record_metadata()
...
def test_next_record_different(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
...
def test_record_same(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
    header1 = harvester.get_record_header()
    header2 = harvester.get_record_header()
    assert header1 == header2
...
def test_two_harvest(setup_data: connect_to_arxiv.ArXivHarvester):
    harvester = setup_data
